                    ...
                    <div class="layui-card-body" pad15>
                        <form class="layui-form" action="">
                            <div class="layui-form-item">
                                <a href="/user/userAdd" class="layui-btn">添加成员</a>
                            </div>
    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'role', title: '家庭角色', width:120, sort: true}
                ,{field: 'auid', title: '成员权限', width:120, sort: true}
                ,{field: 'salary', title: '薪资', width: 81, sort: true}
